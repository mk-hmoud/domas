...
import { StatCard, TableSkeleton, PageHeader, PageShell } from '@domas/ui';
import { useAuth } from '@domas/client-core';

// Shared CSS for dashboard mini-table headers
...
export function DashboardHome() {
  ...
  if (!hasAnySection) {
    return (
      <>
        <PageHeader title={t('dashboard.staff_dashboard_title')} />
        <PageShell>
  ...
  return (
    <>
      <PageHeader
        title={t('dashboard.staff_dashboard_title')}
        subtitle={t('dashboard.staff_portal_intro')}
      />
      <PageShell>
        <Stack gap="xl">
          {showBookings && (
                  ...
                  <Table highlightOnHover>
                    <Table.Thead className={tableClasses.thead}>
                      <Table.Tr>
                        ...
                        <Table.Th className={tableClasses.th}>{t('start_date', 'Start')}</Table.Th>
                        <Table.Th className={tableClasses.th}>{t('end_date', 'End')}</Table.Th>
                      </Table.Tr>
                    </Table.Thead>
                    <Table.Tbody>
                      {loading ? (
                ...
                <Paper withBorder radius="md" style={{ overflow: 'hidden' }}>
                  ...
                  <Table highlightOnHover>
                    <Table.Thead className={tableClasses.thead}>
                      <Table.Tr>
                        <Table.Th className={tableClasses.th}>{t('location')}</Table.Th>
                        <Table.Th className={tableClasses.th}>{t('description')}</Table.Th>
                        <Table.Th className={tableClasses.th}>{t('date')}</Table.Th>

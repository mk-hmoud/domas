...
export function ReportLostCardModal({
  opened,
  onClose,
  card,
  batches,
  ...
  return (
    <Modal
      opened={opened}
      onClose={handleClose}
      title={t("report_lost_card", "Report Lost Card")}
      size="sm"
    >
      <Stack gap="md">
        <Alert icon={<IconAlertTriangle size={16} />} color="red">
          {t("report_lost_card_warning", {
            defaultValue:
              "Card #{{cardNumber}} will be marked as lost and can no longer be used.",
